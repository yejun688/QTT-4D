...
## Installation
Use the install guide from the preivous section to make a Conda adastqtt environment. 

## Dataset
* [Synthetic-NeRF](https://drive.google.com/drive/folders/128yBriW1IG_3NJ5Rp7APSTZsJqdJdfc1)
* [DNeRF](https://drive.google.com/file/d/1uHVyApwqugXTFuIRRlE4abTW8_rrVeIK/view)
* [Neural_3D_Video](https://github.com/facebookresearch/Neural_3D_Video/releases/tag/v1.0) 
* [nerfies](https://drive.google.com/drive/u/0/folders/1gIWA5KbqXF6POSCYKksredkBPAZ-gHRS)
* [HyperNeRF](https://github.com/google/hypernerf/releases/tag/v0.1)
* [iphone](https://drive.google.com/drive/u/0/folders/1ZYQQh0qkvpoGXFIcK_j4suon1Wt6MXdZ)

* [Google Immersive](https://github.com/augmentedperception/deepview_video_dataset)


## Quick Start
The training script is in `train.py`, to train a adastqtt:

```
python train.py --config configs/Dynamic_nerf/Large/dynerf_coffee_martini.txt
```


We provide a few examples in the configuration folder. Please note the following parameters:

- `dataset_name`: choices = ['dnerf', 'dynerf', 'hypernerf', 'iphone_temp'];
- `shadingMode`: choices = ['MLP_Fea', 'SH'];
- `model_name`: choices = ['TensorTT', 'TensorsVMSplit', 'TensorCP'], corresponding to the Quantized Tensor Train, the VM, and CP decomposition.
...
```
python train.py --config configs/Dynamic_nerf/Large/dynerf_coffee_martini.txt --ckpt path/to/your/checkpoint --render_only 1 --render_test 1 
```
...
```
python train.py --config configs/Dynamic_nerf/Large/dynerf_coffee_martini.txt --ckpt path/to/your/checkpoint --export_mesh 1
```
