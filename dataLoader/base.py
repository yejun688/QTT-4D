...
from .pose_utils_gear import create_spherical_poses, create_spiral_poses, interpolate_poses
from .ray_utils_gear import get_ndc_rays_fx_fy, get_ray_directions_K, get_rays
...
class BaseDataset(Dataset):
    def __init__(self, datadir, split="train", downsample=1.0, is_stack=False):
        ...
        self._img_wh = [1280, 960]
        self.img_wh = [1280, 960]
        self.downsample = downsample

        self.centered_pixels = False
...
class Base5DDataset(BaseDataset):
    def __init__(self, datadir, split="train", downsample=1.0, is_stack=False):
        ...
        # Rendering
        self.render_spherical = False
        self.render_interpolate = False
        self.render_max_frames = (
            0
        )
        self.use_ndc = False
        self.include_world = False
