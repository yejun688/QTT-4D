...
def config_parser(cmd=None):
    ...
    # parser.add_argument('--config', is_config_file=True,default = '/data0/PuTT/PuTT-Nerf/configs/lego_PuTT.txt',
    #                     help='config file path') 
    parser.add_argument('--config', is_config_file=True,default = '/data/PuTT/PuTT-Nerf/configs/Dynamic_scene/Large/dnerf_hook_single_qtt_multi_rates.txt',
                         help='config file path')
    parser.add_argument('--is_hyper', type=int, default=False,
                        help='sign for if hyper dataser or not')
    parser.add_argument('--is_immersive', type=int, default=False,
                        help='sign for if hyper dataser or not')
    parser.add_argument('--is_resampling', type=int, default=False,
                        help='sign for if resampling or it')
    parser.add_argument('--add_cam', type=int, default=False,
                        help='sign for if hyper dataser or not')
    ...
    # parser.add_argument("--datadir", type=str, default='/data0/TensoRF/data/nerf_synthetic/ship',
    #                     help='input data directory')
    parser.add_argument("--datadir", type=str, default='/data0/PuTT/PuTT-Nerf/dataset/data/lego',
                        help='input data directory')
    ...
    parser.add_argument('--dataset_name', type=str, default='dnerf',
                        choices=['immersive', 'iphone', 'dnerf', 'hypernerf', 'Dynerf', 'blender', 'llff', 'nsvf', 'dtu','tankstemple', 'own_data'])
    ...
    parser.add_argument("--lr_init_shader", type=float, default=1e-3,
                        help='learning rate')
    parser.add_argument("--lr_init_featurenet", type=float, default=8e-4,
                        help='learning feature rate')    
    parser.add_argument("--lr_init_deformation_net", type=float, default=6e-4,
                        help='learning deformation rate')
    parser.add_argument("--lr_init_density_net", type=float, default=8e-4,
                        help='learning density rate')    
    parser.add_argument("--lr_init_time_net", type=float, default=8e-4,
                        help='learning time rate')
